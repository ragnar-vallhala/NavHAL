 ...
 * hardware CRC unit when NAVHAL_CONFIG_DRV_CRC is defined, otherwise a software
...
/* Software fallback: CRC-32/MPEG-2 (poly 0x04C11DB7, non-reflected) */
