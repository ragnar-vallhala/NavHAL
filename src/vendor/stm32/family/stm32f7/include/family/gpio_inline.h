 ...
 * @brief STM32F7 inlined GPIO accessors.
 *
 * @details
...
#ifndef NAVHAL_STM32F7_GPIO_INLINE_H
#define NAVHAL_STM32F7_GPIO_INLINE_H
...
/** @brief Drive @p pin. BSRR sets from the low half and resets from the high
 *  half, so neither direction is a read-modify-write. */
...
/** @brief Invert @p pin. ODR has no atomic toggle, so this one is a
 *  read-modify-write. */
...
#endif /* NAVHAL_STM32F7_GPIO_INLINE_H */
