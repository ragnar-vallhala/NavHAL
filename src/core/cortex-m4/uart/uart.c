 ...
 */
 ...
 void uart1_init(uint32_t baudrate)
 {
     ...
     USART1_BRR = (hal_clock_get_apb2clk() + (baudrate / 2)) / baudrate; // BRR calculation with rounding
 ...
 void uart6_init(uint32_t baudrate)
 {
     ...
     USART6_BRR = (hal_clock_get_apb2clk() + (baudrate / 2)) / baudrate; // BRR calculation with rounding
 ...
 void uart2_init(uint32_t baudrate)
 {
     ...
     USART2_BRR = (hal_clock_get_apb1clk() + (baudrate / 2)) / baudrate; // BRR calculation with rounding
