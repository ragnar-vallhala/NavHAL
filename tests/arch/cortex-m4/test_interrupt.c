...
/* Word count of the .isr_vector table in src/arch/armv7e-m/startup/startup.s
 * (initial SP + 15 system exceptions + IRQ 0..81, the last being SPI4).
 * Past the end is code, whose words are not vectors and are not odd. */
#define VECTOR_TABLE_ENTRIES 98u
