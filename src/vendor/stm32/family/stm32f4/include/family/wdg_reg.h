...
/**
 * @file wdg_reg.h
 * @brief IWDG and WWDG register maps for STM32F4.
 *
 * @details
 ...
 * running early.
 *
 * Reference: RM0368 §19 (IWDG), §20 (WWDG).
 */

#ifndef CORTEX_M4_WDG_REG_H
#define CORTEX_M4_WDG_REG_H
