 ...
 * @brief Cortex-M4 / STM32F4 Flash key/value storage HAL driver interface.
 *
 * @details
 * Standardized Flash API (see `docs/api_standardization.md`). Provides a
 ...
 * `hal_flash_` prefix and return ::hal_status_t.
 *
