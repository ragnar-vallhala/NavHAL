...
\end{DoxyReturn}
Reads the IDR register for the specified pin and returns the current input state. \Hypertarget{gpio_8c_aa64ac2161a52147ab5e91fe399126638}\index{gpio.c@{gpio.c}!hal\_gpio\_digitalwrite@{hal\_gpio\_digitalwrite}}
...
\end{DoxyReturn}
Reads the MODER register for the specified pin and returns the current mode configuration. \Hypertarget{gpio_8c_a07aab29e77970fa617d8ea0d1922e964}\index{gpio.c@{gpio.c}!hal\_gpio\_set\_alternate\_function@{hal\_gpio\_set\_alternate\_function}}
...
\hline
\end{DoxyParams}
Sets the output speed in the OSPEEDR register for the specified pin. Does not change the pin mode -\/ must be configured separately. \Hypertarget{gpio_8c_a926263a98f6084ec82b2546ddd47d413}\index{gpio.c@{gpio.c}!hal\_gpio\_set\_output\_type@{hal\_gpio\_set\_output\_type}}
...
\hline
\end{DoxyParams}
Sets the output type in the OTYPER register for the specified pin. Does not change the pin mode -\/ must be configured separately. \Hypertarget{gpio_8c_ab063b362fb73bcb899a122e5188e7e32}\index{gpio.c@{gpio.c}!hal\_gpio\_setmode@{hal\_gpio\_setmode}}
