...
\begin{DoxyCompactList}\small\item\em Enable the RCC clock for a GPIO port. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Configure alternate function for a GPIO pin. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Configure GPIO output type. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Configure GPIO output speed. \end{DoxyCompactList}\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
HAL GPIO driver implementation for STM32\+F4 series. 

This file contains the implementation of GPIO hardware abstraction layer functions for STM32\+F4 microcontrollers. It provides complete GPIO pin configuration and control capabilities including\+:
\begin{DoxyItemize}
\item Pin mode configuration (input/output/alternate/analog)
\item Digital input/output operations
\item Alternate function selection
\item Output speed and type configuration
\item Built-\/in pull-\/up/pull-\/down resistor control
\end{DoxyItemize}
...
\end{DoxyReturn}
Reads the IDR register for the specified pin and returns the current input state. \texorpdfstring{$<$}{<} GPIOA base address\Hypertarget{gpio_8c_aa64ac2161a52147ab5e91fe399126638}\index{gpio.c@{gpio.c}!hal\_gpio\_digitalwrite@{hal\_gpio\_digitalwrite}}
...
\texorpdfstring{$<$}{<} GPIOA base address\Hypertarget{gpio_8c_a4f525e1eaa75b82f304bc25cee240789}\index{gpio.c@{gpio.c}!hal\_gpio\_enable\_rcc@{hal\_gpio\_enable\_rcc}}
...
\hline
\end{DoxyParams}
Enables the AHB1 peripheral clock for the GPIO port containing the specified pin. This is automatically called by other GPIO functions when needed. \Hypertarget{gpio_8c_af5915e39ede16cf7d68b4dc1ee02b78a}\index{gpio.c@{gpio.c}!hal\_gpio\_getmode@{hal\_gpio\_getmode}}
...
\end{DoxyReturn}
Reads the MODER register for the specified pin and returns the current mode configuration. \texorpdfstring{$<$}{<} GPIOA base address\Hypertarget{gpio_8c_a07aab29e77970fa617d8ea0d1922e964}\index{gpio.c@{gpio.c}!hal\_gpio\_set\_alternate\_function@{hal\_gpio\_set\_alternate\_function}}
...
\texorpdfstring{$<$}{<} GPIOA base address\Hypertarget{gpio_8c_a02a45d51d8fcbaf0f4bbf08bd76ef7b5}\index{gpio.c@{gpio.c}!hal\_gpio\_set\_output\_speed@{hal\_gpio\_set\_output\_speed}}
...
\texorpdfstring{$<$}{<} GPIOA base address\Hypertarget{gpio_8c_a926263a98f6084ec82b2546ddd47d413}\index{gpio.c@{gpio.c}!hal\_gpio\_set\_output\_type@{hal\_gpio\_set\_output\_type}}
...
\texorpdfstring{$<$}{<} GPIOA base address\Hypertarget{gpio_8c_ab063b362fb73bcb899a122e5188e7e32}\index{gpio.c@{gpio.c}!hal\_gpio\_setmode@{hal\_gpio\_setmode}}
