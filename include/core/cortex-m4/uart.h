 ...
 *
 * This header defines memory-mapped registers, macros, and function prototypes for 
 * UART (USART1, USART2, USART6) peripheral control on the STM32F401RE MCU.
 *
 ...
 *
 * @note Architecture-specific for STM32F401RE. Included through dispatcher based on `CORTEX_M4`.
 ...
 */
  ...
  * 
  *  Defines base addresses and register offsets for all supported UART peripherals,
  *  along with relevant bit definitions for control and status registers.
  *  @{
  */
  ...
  * 
  *  Provides initialization, transmission, and reception functions for UART peripherals.
  *  Both generic (UART instance parameter) and specific (UART1/UART2/UART6) functions
 ...
 /**
  * @brief Read characters into a buffer until a delimiter is found or max length is reached.
  *
