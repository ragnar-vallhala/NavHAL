...
extern "C" {
#endif
/* NVIC lives in arch/armv7e-m/core_reg.h: it is a core peripheral at a
 * fixed architectural address, identical on every ARMv7E-M part. What is
 * this MCU's own is the interrupt numbering below. */
